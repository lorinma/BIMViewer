...
geomlib._kill_pointed = new_instancemethod(_GeomLib.geomlib__kill_pointed,None,geomlib)
...
GeomLib_Array1OfMat._kill_pointed = new_instancemethod(_GeomLib.GeomLib_Array1OfMat__kill_pointed,None,GeomLib_Array1OfMat)
...
GeomLib_Check2dBSplineCurve._kill_pointed = new_instancemethod(_GeomLib.GeomLib_Check2dBSplineCurve__kill_pointed,None,GeomLib_Check2dBSplineCurve)
...
GeomLib_CheckBSplineCurve._kill_pointed = new_instancemethod(_GeomLib.GeomLib_CheckBSplineCurve__kill_pointed,None,GeomLib_CheckBSplineCurve)
...
GeomLib_DenominatorMultiplier._kill_pointed = new_instancemethod(_GeomLib.GeomLib_DenominatorMultiplier__kill_pointed,None,GeomLib_DenominatorMultiplier)
...
GeomLib_Interpolate._kill_pointed = new_instancemethod(_GeomLib.GeomLib_Interpolate__kill_pointed,None,GeomLib_Interpolate)
...
GeomLib_IsPlanarSurface._kill_pointed = new_instancemethod(_GeomLib.GeomLib_IsPlanarSurface__kill_pointed,None,GeomLib_IsPlanarSurface)
...
GeomLib_LogSample._kill_pointed = new_instancemethod(_GeomLib.GeomLib_LogSample__kill_pointed,None,GeomLib_LogSample)
...
GeomLib_MakeCurvefromApprox._kill_pointed = new_instancemethod(_GeomLib.GeomLib_MakeCurvefromApprox__kill_pointed,None,GeomLib_MakeCurvefromApprox)
...
GeomLib_PolyFunc._kill_pointed = new_instancemethod(_GeomLib.GeomLib_PolyFunc__kill_pointed,None,GeomLib_PolyFunc)
...
GeomLib_Tool._kill_pointed = new_instancemethod(_GeomLib.GeomLib_Tool__kill_pointed,None,GeomLib_Tool)
