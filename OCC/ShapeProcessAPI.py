...
ShapeProcessAPI_ApplySequence._kill_pointed = new_instancemethod(_ShapeProcessAPI.ShapeProcessAPI_ApplySequence__kill_pointed,None,ShapeProcessAPI_ApplySequence)
