...
BRepMesh_Delaun.Frontier = new_instancemethod(_BRepMesh.BRepMesh_Delaun_Frontier,None,BRepMesh_Delaun)
BRepMesh_Delaun.InternalEdges = new_instancemethod(_BRepMesh.BRepMesh_Delaun_InternalEdges,None,BRepMesh_Delaun)
BRepMesh_Delaun.FreeEdges = new_instancemethod(_BRepMesh.BRepMesh_Delaun_FreeEdges,None,BRepMesh_Delaun)
