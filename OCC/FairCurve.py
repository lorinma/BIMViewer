...
FairCurve_Batten._kill_pointed = new_instancemethod(_FairCurve.FairCurve_Batten__kill_pointed,None,FairCurve_Batten)
...
FairCurve_BattenLaw._kill_pointed = new_instancemethod(_FairCurve.FairCurve_BattenLaw__kill_pointed,None,FairCurve_BattenLaw)
...
FairCurve_DistributionOfEnergy._kill_pointed = new_instancemethod(_FairCurve.FairCurve_DistributionOfEnergy__kill_pointed,None,FairCurve_DistributionOfEnergy)
...
FairCurve_Energy._kill_pointed = new_instancemethod(_FairCurve.FairCurve_Energy__kill_pointed,None,FairCurve_Energy)
...
FairCurve_Newton._kill_pointed = new_instancemethod(_FairCurve.FairCurve_Newton__kill_pointed,None,FairCurve_Newton)
...
FairCurve_DistributionOfJerk._kill_pointed = new_instancemethod(_FairCurve.FairCurve_DistributionOfJerk__kill_pointed,None,FairCurve_DistributionOfJerk)
...
FairCurve_DistributionOfSagging._kill_pointed = new_instancemethod(_FairCurve.FairCurve_DistributionOfSagging__kill_pointed,None,FairCurve_DistributionOfSagging)
...
FairCurve_DistributionOfTension._kill_pointed = new_instancemethod(_FairCurve.FairCurve_DistributionOfTension__kill_pointed,None,FairCurve_DistributionOfTension)
...
FairCurve_EnergyOfBatten._kill_pointed = new_instancemethod(_FairCurve.FairCurve_EnergyOfBatten__kill_pointed,None,FairCurve_EnergyOfBatten)
...
FairCurve_EnergyOfMVC._kill_pointed = new_instancemethod(_FairCurve.FairCurve_EnergyOfMVC__kill_pointed,None,FairCurve_EnergyOfMVC)
...
FairCurve_MinimalVariation._kill_pointed = new_instancemethod(_FairCurve.FairCurve_MinimalVariation__kill_pointed,None,FairCurve_MinimalVariation)
