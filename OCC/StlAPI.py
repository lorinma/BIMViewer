...
stlapi._kill_pointed = new_instancemethod(_StlAPI.stlapi__kill_pointed,None,stlapi)
...
StlAPI_Reader._kill_pointed = new_instancemethod(_StlAPI.StlAPI_Reader__kill_pointed,None,StlAPI_Reader)
...
StlAPI_Writer._kill_pointed = new_instancemethod(_StlAPI.StlAPI_Writer__kill_pointed,None,StlAPI_Writer)
