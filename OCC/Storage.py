...
Storage_Bucket.Clear = new_instancemethod(_Storage.Storage_Bucket_Clear,None,Storage_Bucket)
Storage_Bucket._kill_pointed = new_instancemethod(_Storage.Storage_Bucket__kill_pointed,None,Storage_Bucket)
...
Storage_BucketIterator.Init = new_instancemethod(_Storage.Storage_BucketIterator_Init,None,Storage_BucketIterator)
Storage_BucketIterator.Reset = new_instancemethod(_Storage.Storage_BucketIterator_Reset,None,Storage_BucketIterator)
Storage_BucketIterator.Value = new_instancemethod(_Storage.Storage_BucketIterator_Value,None,Storage_BucketIterator)
Storage_BucketIterator.More = new_instancemethod(_Storage.Storage_BucketIterator_More,None,Storage_BucketIterator)
Storage_BucketIterator.Next = new_instancemethod(_Storage.Storage_BucketIterator_Next,None,Storage_BucketIterator)
Storage_BucketIterator._kill_pointed = new_instancemethod(_Storage.Storage_BucketIterator__kill_pointed,None,Storage_BucketIterator)
...
Storage_BucketOfPersistent.Length = new_instancemethod(_Storage.Storage_BucketOfPersistent_Length,None,Storage_BucketOfPersistent)
Storage_BucketOfPersistent.Append = new_instancemethod(_Storage.Storage_BucketOfPersistent_Append,None,Storage_BucketOfPersistent)
Storage_BucketOfPersistent.Value = new_instancemethod(_Storage.Storage_BucketOfPersistent_Value,None,Storage_BucketOfPersistent)
Storage_BucketOfPersistent.Clear = new_instancemethod(_Storage.Storage_BucketOfPersistent_Clear,None,Storage_BucketOfPersistent)
Storage_BucketOfPersistent._kill_pointed = new_instancemethod(_Storage.Storage_BucketOfPersistent__kill_pointed,None,Storage_BucketOfPersistent)
