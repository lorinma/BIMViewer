...
AppCont_FitFunction._kill_pointed = new_instancemethod(_AppCont.AppCont_FitFunction__kill_pointed,None,AppCont_FitFunction)
...
AppCont_FitFunction2d._kill_pointed = new_instancemethod(_AppCont.AppCont_FitFunction2d__kill_pointed,None,AppCont_FitFunction2d)
...
AppCont_Function._kill_pointed = new_instancemethod(_AppCont.AppCont_Function__kill_pointed,None,AppCont_Function)
...
AppCont_Function2d._kill_pointed = new_instancemethod(_AppCont.AppCont_Function2d__kill_pointed,None,AppCont_Function2d)
...
AppCont_FunctionTool._kill_pointed = new_instancemethod(_AppCont.AppCont_FunctionTool__kill_pointed,None,AppCont_FunctionTool)
...
AppCont_FunctionTool2d._kill_pointed = new_instancemethod(_AppCont.AppCont_FunctionTool2d__kill_pointed,None,AppCont_FunctionTool2d)
