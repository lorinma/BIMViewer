...
TopBas_ListIteratorOfListOfTestInterference._kill_pointed = new_instancemethod(_TopBas.TopBas_ListIteratorOfListOfTestInterference__kill_pointed,None,TopBas_ListIteratorOfListOfTestInterference)
...
TopBas_ListNodeOfListOfTestInterference._kill_pointed = new_instancemethod(_TopBas.TopBas_ListNodeOfListOfTestInterference__kill_pointed,None,TopBas_ListNodeOfListOfTestInterference)
TopBas_ListNodeOfListOfTestInterference.GetHandle = new_instancemethod(_TopBas.TopBas_ListNodeOfListOfTestInterference_GetHandle,None,TopBas_ListNodeOfListOfTestInterference)
...
Handle_TopBas_ListNodeOfListOfTestInterference._kill_pointed = new_instancemethod(_TopBas.Handle_TopBas_ListNodeOfListOfTestInterference__kill_pointed,None,Handle_TopBas_ListNodeOfListOfTestInterference)
...
TopBas_ListOfTestInterference._kill_pointed = new_instancemethod(_TopBas.TopBas_ListOfTestInterference__kill_pointed,None,TopBas_ListOfTestInterference)
...
TopBas_TestInterference._kill_pointed = new_instancemethod(_TopBas.TopBas_TestInterference__kill_pointed,None,TopBas_TestInterference)
