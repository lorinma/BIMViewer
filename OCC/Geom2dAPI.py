...
Geom2dAPI_ExtremaCurveCurve._kill_pointed = new_instancemethod(_Geom2dAPI.Geom2dAPI_ExtremaCurveCurve__kill_pointed,None,Geom2dAPI_ExtremaCurveCurve)
...
Geom2dAPI_InterCurveCurve._kill_pointed = new_instancemethod(_Geom2dAPI.Geom2dAPI_InterCurveCurve__kill_pointed,None,Geom2dAPI_InterCurveCurve)
...
Geom2dAPI_Interpolate._kill_pointed = new_instancemethod(_Geom2dAPI.Geom2dAPI_Interpolate__kill_pointed,None,Geom2dAPI_Interpolate)
...
Geom2dAPI_PointsToBSpline._kill_pointed = new_instancemethod(_Geom2dAPI.Geom2dAPI_PointsToBSpline__kill_pointed,None,Geom2dAPI_PointsToBSpline)
...
Geom2dAPI_ProjectPointOnCurve._kill_pointed = new_instancemethod(_Geom2dAPI.Geom2dAPI_ProjectPointOnCurve__kill_pointed,None,Geom2dAPI_ProjectPointOnCurve)
