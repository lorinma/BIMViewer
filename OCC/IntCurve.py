...
IntCurve_IConicTool._kill_pointed = new_instancemethod(_IntCurve.IntCurve_IConicTool__kill_pointed,None,IntCurve_IConicTool)
...
IntCurve_MyImpParToolOfIntImpConicParConic._kill_pointed = new_instancemethod(_IntCurve.IntCurve_MyImpParToolOfIntImpConicParConic__kill_pointed,None,IntCurve_MyImpParToolOfIntImpConicParConic)
...
IntCurve_PConic._kill_pointed = new_instancemethod(_IntCurve.IntCurve_PConic__kill_pointed,None,IntCurve_PConic)
...
IntCurve_PConicTool._kill_pointed = new_instancemethod(_IntCurve.IntCurve_PConicTool__kill_pointed,None,IntCurve_PConicTool)
...
IntCurve_ProjectOnPConicTool._kill_pointed = new_instancemethod(_IntCurve.IntCurve_ProjectOnPConicTool__kill_pointed,None,IntCurve_ProjectOnPConicTool)
