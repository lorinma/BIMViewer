...
MMgt_TShared._kill_pointed = new_instancemethod(_MMgt.MMgt_TShared__kill_pointed,None,MMgt_TShared)
MMgt_TShared.GetHandle = new_instancemethod(_MMgt.MMgt_TShared_GetHandle,None,MMgt_TShared)
...
Handle_MMgt_TShared._kill_pointed = new_instancemethod(_MMgt.Handle_MMgt_TShared__kill_pointed,None,Handle_MMgt_TShared)
