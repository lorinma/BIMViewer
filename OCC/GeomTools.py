...
GeomTools_CurveSet._kill_pointed = new_instancemethod(_GeomTools.GeomTools_CurveSet__kill_pointed,None,GeomTools_CurveSet)
...
GeomTools_SurfaceSet._kill_pointed = new_instancemethod(_GeomTools.GeomTools_SurfaceSet__kill_pointed,None,GeomTools_SurfaceSet)
...
GeomTools_UndefinedTypeHandler._kill_pointed = new_instancemethod(_GeomTools.GeomTools_UndefinedTypeHandler__kill_pointed,None,GeomTools_UndefinedTypeHandler)
GeomTools_UndefinedTypeHandler.GetHandle = new_instancemethod(_GeomTools.GeomTools_UndefinedTypeHandler_GetHandle,None,GeomTools_UndefinedTypeHandler)
...
Handle_GeomTools_UndefinedTypeHandler._kill_pointed = new_instancemethod(_GeomTools.Handle_GeomTools_UndefinedTypeHandler__kill_pointed,None,Handle_GeomTools_UndefinedTypeHandler)
