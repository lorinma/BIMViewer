...
XCAFApp_Application._kill_pointed = new_instancemethod(_XCAFApp.XCAFApp_Application__kill_pointed,None,XCAFApp_Application)
XCAFApp_Application.GetHandle = new_instancemethod(_XCAFApp.XCAFApp_Application_GetHandle,None,XCAFApp_Application)
...
Handle_XCAFApp_Application._kill_pointed = new_instancemethod(_XCAFApp.Handle_XCAFApp_Application__kill_pointed,None,Handle_XCAFApp_Application)
