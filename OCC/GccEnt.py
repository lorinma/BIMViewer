...
gccent._kill_pointed = new_instancemethod(_GccEnt.gccent__kill_pointed,None,gccent)
...
GccEnt_Array1OfPosition._kill_pointed = new_instancemethod(_GccEnt.GccEnt_Array1OfPosition__kill_pointed,None,GccEnt_Array1OfPosition)
...
GccEnt_QualifiedCirc._kill_pointed = new_instancemethod(_GccEnt.GccEnt_QualifiedCirc__kill_pointed,None,GccEnt_QualifiedCirc)
...
GccEnt_QualifiedLin._kill_pointed = new_instancemethod(_GccEnt.GccEnt_QualifiedLin__kill_pointed,None,GccEnt_QualifiedLin)
