...
gce_MakeMirror._kill_pointed = new_instancemethod(_gce.gce_MakeMirror__kill_pointed,None,gce_MakeMirror)
...
gce_MakeMirror2d._kill_pointed = new_instancemethod(_gce.gce_MakeMirror2d__kill_pointed,None,gce_MakeMirror2d)
...
gce_MakeRotation._kill_pointed = new_instancemethod(_gce.gce_MakeRotation__kill_pointed,None,gce_MakeRotation)
...
gce_MakeRotation2d._kill_pointed = new_instancemethod(_gce.gce_MakeRotation2d__kill_pointed,None,gce_MakeRotation2d)
...
gce_MakeScale._kill_pointed = new_instancemethod(_gce.gce_MakeScale__kill_pointed,None,gce_MakeScale)
...
gce_MakeScale2d._kill_pointed = new_instancemethod(_gce.gce_MakeScale2d__kill_pointed,None,gce_MakeScale2d)
...
gce_MakeTranslation._kill_pointed = new_instancemethod(_gce.gce_MakeTranslation__kill_pointed,None,gce_MakeTranslation)
...
gce_MakeTranslation2d._kill_pointed = new_instancemethod(_gce.gce_MakeTranslation2d__kill_pointed,None,gce_MakeTranslation2d)
...
gce_Root._kill_pointed = new_instancemethod(_gce.gce_Root__kill_pointed,None,gce_Root)
...
gce_MakeCirc._kill_pointed = new_instancemethod(_gce.gce_MakeCirc__kill_pointed,None,gce_MakeCirc)
...
gce_MakeCirc2d._kill_pointed = new_instancemethod(_gce.gce_MakeCirc2d__kill_pointed,None,gce_MakeCirc2d)
...
gce_MakeCone._kill_pointed = new_instancemethod(_gce.gce_MakeCone__kill_pointed,None,gce_MakeCone)
...
gce_MakeCylinder._kill_pointed = new_instancemethod(_gce.gce_MakeCylinder__kill_pointed,None,gce_MakeCylinder)
...
gce_MakeDir._kill_pointed = new_instancemethod(_gce.gce_MakeDir__kill_pointed,None,gce_MakeDir)
...
gce_MakeDir2d._kill_pointed = new_instancemethod(_gce.gce_MakeDir2d__kill_pointed,None,gce_MakeDir2d)
...
gce_MakeElips._kill_pointed = new_instancemethod(_gce.gce_MakeElips__kill_pointed,None,gce_MakeElips)
...
gce_MakeElips2d._kill_pointed = new_instancemethod(_gce.gce_MakeElips2d__kill_pointed,None,gce_MakeElips2d)
...
gce_MakeHypr._kill_pointed = new_instancemethod(_gce.gce_MakeHypr__kill_pointed,None,gce_MakeHypr)
...
gce_MakeHypr2d._kill_pointed = new_instancemethod(_gce.gce_MakeHypr2d__kill_pointed,None,gce_MakeHypr2d)
...
gce_MakeLin._kill_pointed = new_instancemethod(_gce.gce_MakeLin__kill_pointed,None,gce_MakeLin)
...
gce_MakeLin2d._kill_pointed = new_instancemethod(_gce.gce_MakeLin2d__kill_pointed,None,gce_MakeLin2d)
...
gce_MakeParab._kill_pointed = new_instancemethod(_gce.gce_MakeParab__kill_pointed,None,gce_MakeParab)
...
gce_MakeParab2d._kill_pointed = new_instancemethod(_gce.gce_MakeParab2d__kill_pointed,None,gce_MakeParab2d)
...
gce_MakePln._kill_pointed = new_instancemethod(_gce.gce_MakePln__kill_pointed,None,gce_MakePln)
